...
class ContribuyentesControllerTest < ActionController::TestCase
  ...
  test "should create contribuyente" do
    assert_difference('Contribuyente.count') do
      post :create, contribuyente: { calle: @contribuyente.calle, colonia: @contribuyente.colonia, departamento: @contribuyente.departamento, municipio: @contribuyente.municipio, nit: @contribuyente.nit, no_casa: @contribuyente.no_casa, nombre: @contribuyente.nombre, telefono: @contribuyente.telefono, tipo_contribuyente: @contribuyente.tipo_contribuyente, zona: @contribuyente.zona }
    end
